...
var PurchaserequestlineitemListComponent = /** @class */ (function () {
    function PurchaserequestlineitemListComponent(PurchaserequestSvc, PurchaserequestlineitemSvc, route, router) {
        this.PurchaserequestSvc = PurchaserequestSvc;
        this.PurchaserequestlineitemSvc = PurchaserequestlineitemSvc;
        this.route = route;
        this.router = router;
    }
    PurchaserequestlineitemListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.paramMap
    ...
    PurchaserequestlineitemListComponent = __decorate([
        core_1.Component({
    ...
    return PurchaserequestlineitemListComponent;
}());
exports.PurchaserequestlineitemListComponent = PurchaserequestlineitemListComponent;
